...
namespace State
{
    ...
    :   State_Base (application)
    {
        ...
        m_splashes.push({0.3, getResources().getTexture (Texture_ID::Splash_SFML)});
        m_splashes.push({1.4, getResources().getTexture (Texture_ID::Splash_MH), getResources().getSound(Sound_ID::Splash_Made_By)});
    }
